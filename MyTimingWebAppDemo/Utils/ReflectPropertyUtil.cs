...
namespace MyTimingWebAppDemo.Utils
{
    internal static class ReflectPropertyUtil<T>
    {
        ...
        {
            var properties = entity.GetType().GetProperties();
            return properties.Select(property => property.GetValue(entity, null))
                .Select(value => value != null ? value.ToString() : "").ToList();
        }
        ...
        {
            var properties = entity.GetType().GetProperties();
            return properties.Where(property => propertyList.Contains(property.Name))
                .ToDictionary(property => property.Name, property => Type.GetTypeCode(property.PropertyType));
        }
        ...
        public static Dictionary<string, TypeCode> ReflectGetPropertyKeyTypePairs(T entity)
        {
            ...
            return properties.ToDictionary(property => property.Name,
                property => Type.GetTypeCode(property.PropertyType));
        }
