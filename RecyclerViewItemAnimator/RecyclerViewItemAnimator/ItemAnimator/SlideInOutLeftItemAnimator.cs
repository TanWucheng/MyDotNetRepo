...
{
    public class SlideInOutLeftItemAnimator : BaseItemAnimator
    {
        public SlideInOutLeftItemAnimator(RecyclerView recyclerView) : base(recyclerView)
        {
        }
        ...
        {
            private readonly SlideInOutLeftItemAnimator _itemAnimator;
            private readonly RecyclerView.ViewHolder _holder;
            private readonly ViewPropertyAnimatorCompat _animation;
            private readonly float _width;

            public AnimateRemoveVpaListener(SlideInOutLeftItemAnimator itemAnimator
        ...
        private class AnimateAddVpaListener : Java.Lang.Object, IViewPropertyAnimatorListener
        {
            ...
            public AnimateAddVpaListener(SlideInOutLeftItemAnimator itemAnimator
                , RecyclerView.ViewHolder holder
                , ViewPropertyAnimatorCompat animation)
            {
                _itemAnimator = itemAnimator;
